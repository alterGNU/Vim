...
let g:normed_project_list = ["first_try","second_try","libft","libft_enhanced","ft_printf","get_next_line","GNL","push_swap", "pipex", "so_long", "minishell", "philo", "philosophers", "miniRT", "cub3d"]
